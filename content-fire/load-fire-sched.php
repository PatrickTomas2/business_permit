...
<?php
    ...
    $query = "SELECT business_registration.business_name, fire_inspection_request.isAccepted, fire_inspection_request.inspection_schedule FROM business_registration INNER JOIN fire_inspection_request ON business_registration.business_id = fire_inspection_request.business_id WHERE fire_inspection_request.isAccepted = '1' AND fire_inspection_request.isDone = '0' AND DATE(fire_inspection_request.inspection_schedule) = CURDATE();";
