<?php
    ...
    $select_request_count = mysqli_query($conn, "SELECT COUNT(request_id) AS pending FROM sanitary_inspection_request WHERE isAccepted = '0' AND isDone = '0'");
...
<head>
    ...
    <script src="js/sanitary.js?ver=007"></script>
    <title>Sanitary Admin</title>
    <style>
        #content-placeholder {
            height: 700px;
            overflow-y: auto;
