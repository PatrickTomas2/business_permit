...
$queryChecklist = "INSERT INTO business_permit_renewal VALUES('$renewal_id', '$user_id', '$business_id', '$destination1', '$destination2', '$destination3', '$destination4', '$destination5', '0', NOW())";
