<?php
    ...
    $upcoming_sched = mysqli_query($conn, "SELECT COUNT(request_id) AS upcoming FROM fire_inspection_request WHERE isAccepted = '1' AND isDone = '0' AND DATE(inspection_schedule) > CURDATE();");
    if (mysqli_num_rows($count_pending) > 0) {
      $row = mysqli_fetch_assoc($upcoming_sched);
...
$(document).ready(function() {
    ...
    const upcoming = <?php echo $upcoming; ?>;
