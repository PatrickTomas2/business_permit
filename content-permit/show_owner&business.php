          ...
          <div class="card-body">
            ...
            <div class="row align-items-center justify-content-center mt-4">
                <div class="col-12 col-md-4 text-center">
                    <button type="button" class="f-n-hover btn btn-success btn-raised px-4 py-25 w-75 text-600" onclick="approveApplicant('<?php echo $permit_id;?>')">APPROVE</button>
                </div>
            </div>
  </div>
</div>
