<?php
    ...
    $select_user_info = mysqli_query($conn, "SELECT * FROM owner_information INNER JOIN business_registration ON owner_information.owner_id = business_registration.owner_id WHERE owner_information.owner_id='$user_id' AND business_registration.business_id ='$business'");
...
<head>
    ...
    <script src="js/renewal.js?ver=002"></script>
    <title>Renewal</title>
  ...
  <div class="wrapper">
    ...
    <div class="terms-info">
                    ...
                    <div class="get-info mb-3">
                        ...
                        <p><i>
                        *Please fill in the necessary information below so that we can assist you better. Only <strong>jpeg, jpg,</strong> and <strong> png </strong>formats are allowed. Your input is important for us to provide the right support. Thank you!
                        </i></p>
                    <form id="postForm" enctype="multipart/form-data">
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingOne">
                                <button id="req1_btn" class="accordion-button custom-btn text-danger fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                                BIR Sales Tax Returns of the Prior Year<span id="req1_error" class="error"></span>
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <div class="mb-3">
                                        <label for="req1" class="file_input">Upload BIR Sales Tax Returns of the Prior Year</label>
                    ...
                    <h2 class="accordion-header" id="headingThree">
                        ...
                        ZONING CERTIFICATE<span id="req3_error" class="error"></span>
                            <i class="bi bi-chevron-down ml-auto"></i> <!-- Bootstrap icon for toggling -->
                        </button>
                    </h2>
                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <div class="mb-3">
                                <label for="req3" class="file_input">Upload zoning certificate </label>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingFour">
                        <button id="req4_btn" class="accordion-button custom-btn text-danger fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                            FIRE SAFETY INSPECTION PERMIT<span id="req4_error" class="error"></span>
                            <i class="bi bi-chevron-down ml-auto"></i> <!-- Bootstrap icon for toggling -->
                        </button>
                    </h2>
                    <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <div class="mb-3">
                                <label for="req4" class="file_input">Upload fire safety inspection permit</label>
