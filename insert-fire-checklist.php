...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO fire_safety_checklist VALUES ('', $values, '$recommendation', NOW())";
    $insert_fire_inspection = mysqli_query($conn, $sql);

    if ($insert_fire_inspection) {
        $sql_two = "UPDATE fire_inspection_request INNER JOIN business_registration ON fire_inspection_request.business_id = business_registration.business_id SET fire_inspection_request.isDone = '1' WHERE business_registration.business_name = '$business_name'";
